...
export const ExploreSidebar = memo(function ExploreSidebar({
  isOpen,
  isCollapsed,
  onToggle,
  onClose,
          ...
          >
            ...
            >
              {!isCollapsed && (
                ...
                >
                  <img src="/logo.png" alt="StarRink" className="h-8 w-8 rounded-lg object-cover" />
            ...
            {/* Navigation */}
            <ExploreSidebarNav isCollapsed={isCollapsed} />
