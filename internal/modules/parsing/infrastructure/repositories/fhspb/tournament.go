...
func (r *TournamentRepository) Upsert(ctx context.Context, t *Tournament) (string, error) {
	...
	err := r.db.QueryRowContext(ctx, query, id, t.ExternalID, t.URL, t.Name, t.Domain, t.BirthYear, t.GroupName, t.Season, t.StartDate, t.EndDate, t.IsEnded, RegionSPB, SourceFHSPB).Scan(&returnedID)
